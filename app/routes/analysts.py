...
from app.models.analysts import AnalystCreate, AnalystResponse
from app.repositories.analysts import create_analyst, get_analyst_by_id, get_analyst_by_username
